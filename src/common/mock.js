...
const data = [
  ...
  },
  {
    ...
    config: {
      ...
      columns: [
        { id: 'score_1', value: 1, label: '1分 完全不认可' },
        { id: 'score_2', value: 2, label: '2分 不太认可' },
        { id: 'score_3', value: 3, label: '3分 一般' },
        { id: 'score_4', value: 4, label: '4分 比较认可' },
        { id: 'score_5', value: 5, label: '5分 非常认可' },
      ],
      rows: [
        {
  ...
  },
  {
    ...
    config: {
      ...
      rightLabel: '偏右',
      columns: [
        { id: 'level_1', value: 1, label: '1星 轻微偏向' },
        { id: 'level_2', value: 2, label: '2星 有一点偏向' },
        { id: 'level_3', value: 3, label: '3星 比较偏向' },
        { id: 'level_4', value: 4, label: '4星 明显偏向' },
        { id: 'level_5', value: 5, label: '5星 强烈偏向' },
      ],
      rows: [
        {
          id: 'price_position',
  ...
  },
  {
    ...
    config: {
      ...
      columns: [
        { id: 'score_1', value: 1, label: '1分', description: '很不满意' },
        { id: 'score_2', value: 2, label: '2分', description: '不太满意' },
        { id: 'score_3', value: 3, label: '3分', description: '一般' },
        { id: 'score_4', value: 4, label: '4分', description: '比较满意' },
        { id: 'score_5', value: 5, label: '5分', description: '非常满意' },
      ],
    },
  },
  {
    ...
    config: {
      ...
      columns: [
        ...
        { id: 'nps_4', value: 4, label: '4' },
        { id: 'nps_5', value: 5, label: '5' },
        { id: 'nps_6', value: 6, label: '6' },
        { id: 'nps_7', value: 7, label: '7' },
        { id: 'nps_8', value: 8, label: '8' },
        { id: 'nps_9', value: 9, label: '9' },
        { id: 'nps_10', value: 10, label: '10' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    config: {
      ...
      columns: [
        { id: 'score_1', value: 1, label: '1分', description: '很差' },
        { id: 'score_2', value: 2, label: '2分', description: '偏差' },
        { id: 'score_3', value: 3, label: '3分', description: '一般' },
        { id: 'score_4', value: 4, label: '4分', description: '不错' },
        { id: 'score_5', value: 5, label: '5分', description: '很好' },
      ],
      rows: [
        {
          id: 'service_attitude',
          label: '服务态度',
          description: '工作人员是否主动、友好、能解决问题',
        },
        {
          id: 'store_cleanliness',
          label: '门店整洁度',
          description: '桌面、地面、取餐区和卫生间的整体观感',
        },
        {
          id: 'waiting_time',
          label: '等待时间',
          description: '排队、点单、出餐或取餐等待是否可接受',
        },
        {
          id: 'product_value',
          label: '产品性价比',
          description: '价格、份量、品质和复购意愿的综合判断',
        },
      ],
    },
  },
  {
    ...
    config: {
      ...
      rightLabel: '偏右',
      columns: [
        { id: 'level_1', value: 1, label: '1星 轻微' },
        { id: 'level_2', value: 2, label: '2星 有点' },
        { id: 'level_3', value: 3, label: '3星 明显' },
        { id: 'level_4', value: 4, label: '4星 很明显' },
        { id: 'level_5', value: 5, label: '5星 强烈' },
      ],
      rows: [
        {
          id: 'price_image',
