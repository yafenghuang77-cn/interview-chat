...
export interface MatrixRatingRow<
  T extends MatrixRatingValue = MatrixRatingValue,
> {
...
export type MatrixRatingAnswer<
  R extends MatrixRatingValue = MatrixRatingValue,
> = Partial<Record<R, number>>;

export interface MatrixRatingChangePayload<
  R extends MatrixRatingValue = MatrixRatingValue,
> {
...
export interface MatrixRatingProps<
  R extends MatrixRatingValue = MatrixRatingValue,
> {
  ...
  onChange?: (
    value: MatrixRatingAnswer<R>,
    payload: MatrixRatingChangePayload<R>,
  ) => void;
}
