...
export const getRecordKey = (value: MultiBidirectionalRatingValue): string => String(value);

export const getBidirectionalRatingValue = <R extends MultiBidirectionalRatingValue>(
  answer: MultiBidirectionalRatingAnswer<R>,
  rowValue: R,
): MultiBidirectionalRatingScore | undefined => answer[getRecordKey(rowValue) as R];
